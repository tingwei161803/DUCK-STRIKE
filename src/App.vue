...
import type { WeaponId, Difficulty, DogUpgradeKind, WeaponModKind } from './game/config'
...
function buyWeaponMod(kind: WeaponModKind) { game?.buyWeaponMod(kind) }
...
<template>
  ...
  <!-- 購買選單 -->
  <BuyMenu v-if="state.phase === 'buy'" :state="state" @buy="buy" @armor="buyArmor" @medkit="buyMedkit" @dog="buyDog" @dogup="buyDogUpgrade" @wmod="buyWeaponMod" @next="nextWave" />
